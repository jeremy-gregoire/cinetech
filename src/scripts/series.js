import { getPopularSeriesByPage } from '../../assets/scripts/main.js';
...
function updateListing() {
  ...
  getPopularSeriesByPage(currentPage).then((data) => {
    ...
    data.results.forEach((movie) => {
      ...
      a.href = `details.html?id=${movie.id}&type=tv`;
      seriesContainer.appendChild(a);
